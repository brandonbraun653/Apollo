...
Int32 main( )
{
    ...
    /* TODO: Board check should be done */
    ...
    printf(" Enter 2 ----> To ERASE Flash\n");
    printf(" Enter 3 ----> To EXIT\n");
    scanf("%d",&flash_operation);
    switch (flash_operation)
    {
        case 1:
            ...
            break;
        case 2:
            printf("Flash size is: 0x%x\n",flash->size);
            printf("Enter erase size (in HEX)\n");
            scanf("%x",&flash_size);
            flash->erase (flash, (offset/sector_size)*sector_size,
                            flash_size);
            break;

...
#define ENETPHY_MMD_CTRL                      (0x0D)
#define ENETPHY_MMD_DATA                      (0x0E)

/* PHY MMD register definitions */
#define ENETPHY_MMD_DEVICE_ADDR_0             (0)
#define ENETPHY_MMD_DEVICE_ADDR_1             (1)
#define ENETPHY_MMD_DEVICE_ADDR_2             (2)
#define ENETPHY_MMD_DEVICE_ADDR_3             (3)
#define ENETPHY_MMD_RX_DATA_SKEW_REG          (5)
#define ENETPHY_MMD_TX_DATA_SKEW_REG          (6)
#define ENETPHY_MMD_CLOCK_SKEW_REG            (8)
...
/* Phy Mode Values  */
#define NWAY_AUTOMDIX        (((uint32_t)1u)<<((uint32_t)16u))
#define NWAY_FD1000          (((uint32_t)1u)<<((uint32_t)13u))
#define NWAY_HD1000          (((uint32_t)1u)<<((uint32_t)12u))
#define NWAY_NOPHY          (((uint32_t)1u)<<((uint32_t)10u))
#define NWAY_LPBK            (((uint32_t)1u)<<((uint32_t)9u))
#define NWAY_FD100          (((uint32_t)1u)<<((uint32_t)8u))
#define NWAY_HD100          (((uint32_t)1u)<<((uint32_t)7u))
#define NWAY_FD10           (((uint32_t)1u)<<((uint32_t)6u))
#define NWAY_HD10           (((uint32_t)1u)<<((uint32_t)5u))
#define NWAY_AUTO          (((uint32_t)1u)<<((uint32_t)0u))

#define NWAY_AUTOMDIX_ENABLE (1u<<15)

/* Tic() return values */
#define _MIIMDIO_MDIXFLIP (((uint32_t)1u)<<((uint32_t)28u))

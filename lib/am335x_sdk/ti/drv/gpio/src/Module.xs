/******************************************************************************
 * FILE PURPOSE: GPIO Driver Source Module specification file.
 ******************************************************************************
 * FILE NAME: module.xs
 *
 * DESCRIPTION: 
 *  This file contains the module specification for the GPIO Driver
 *
...
/* List of all the GPIO Driver Files */
var gpioSockLibFiles = [
    "src/GPIO_drv.c",
    "src/v0/GPIO_v0.c",
    "src/v1/GPIO_v1.c",
 ...
 **************************************************************************
 * DESCRIPTION   :
 *  The function is used to build the GPIO LLD Driver and to add the core
...
function modBuild() 
{
    if (socs.length != 0)
    {
        ...
        {
            var targetFiles = gpioSockLibFiles.slice(); /* make copy */
            var libOptions = {
        ...
        for (var soc=0; soc < soc_names.length; soc++) 
        {
            ...
            { 
                var targetFiles_soc = gpioSockLibFiles.slice(); /* make copy */

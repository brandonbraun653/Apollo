...
/* loading an ELF file, but useful when loading a binary        */
    ...
    .text:PRU_X_START : palign(0x80)    >  0x0, PAGE 0
    .text:alert_state : palign(0x80) > 0x100, PAGE 0
    .text:ready_state : palign(0x200) > 0x200, PAGE 0
    .text:end_state : palign(0x200) > 0x400, PAGE 0
    .text:read_state_single : palign(0x200) > 0x600, PAGE 0
    .text:read_state_dual : palign(0x200) > 0x800, PAGE 0
    .text:read_state_quad : palign(0x200) > 0xA00, PAGE 0
    .text:write_state_single : palign(0x200) > 0xC00, PAGE 0
    .text:write_state_dual : palign(0x200) > 0xE00, PAGE 0
    .text:write_state_quad : palign(0x200) > 0x1000, PAGE 0
    .text:tar_state_single : palign(0x200) > 0x1200, PAGE 0
    .text:tar_state_dual : palign(0x200) > 0x1400, PAGE 0
    .text:tar_state_quad : palign(0x200) > 0x1600, PAGE 0

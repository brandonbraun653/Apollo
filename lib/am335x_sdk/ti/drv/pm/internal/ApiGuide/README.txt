...
- Install doxygen for Windows from the below link.
  ...
  Preferably install 1.6.1 version,Software can be found at
  \\vault53\psp\netra DSS\Setup\Doxygen
...
- Edit "pm_api.cfg", goto below line and change path
...
- This will generate a .CHM at below path
  pm\docs\PM_ApiGuide.chm

- It will delete all temporary generated files.

- The .CHM is generated from the source code located at
  pm\include\<Module>\*.h

- All source code input and .CHM output paths are specified relative to
  pm\internal\ApiGuide

...
/** ============================================================================
 *   @n@b CSL_EMIFb_getBaseAddr
 *
 *   @b Description
 *   @n This API gets the EMIFb instance. This should always be the first call
 *      to the CSL EMIFb Functional layer. The handle  which is returned from
 *      this call should be passed in all subsequent CSL API's.
 *
 *   <b> Return Value </b>
 *   @n  CSL_EmifbHandle  - Handle to the EMIFb Module
 *   @n  0                 - Error.
 *
 *   <b> Pre Condition </b>
 *   @n  None
 ...
 *   @b  Example
 *   @verbatim
        CSL_EmifbHandle   hEmifb;
        ...
        hEmif4f = CSL_EMIFb_getBaseAddr (0);    // Opens EMIF4F Instance 0
        ...
     @endverbatim
 * ===========================================================================
 */

CSL_EmifbHandle CSL_EMIFb_getBaseAddr (int32_t instNum);
CSL_EmifbHandle CSL_EMIFb_getBaseAddr (int32_t instNum)
{
    CSL_EmifbHandle ret_val = (CSL_EmifbHandle) 0;
    switch (instNum)
    {
        ...
        case CSL_EMIFB:
        {
            ret_val = (CSL_EmifbHandle) CSL_EMIFB_0_REGS;
            break;
        }

        default:
        {
            ret_val = (CSL_EmifbHandle) 0;
            break;
        }
    }
    return(ret_val);

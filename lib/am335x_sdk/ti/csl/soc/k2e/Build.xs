...
/* CSL Version File */
var cslSocFile = [
    "soc/k2e/src/csl_version.c",
    "soc/k2e/src/csl_gpioGetBaseAddress.c",
    "soc/k2e/src/csl_edma3GetBaseAddress.c",
    "soc/k2e/src/csl_tsipGetBaseAddress.c",
    "soc/k2e/src/csl_cpIntcGetBaseAddress.c",
    "soc/k2e/src/csl_timerGetBaseAddress.c",
    "soc/k2e/src/csl_pllcGetBaseAddress.c",
    "soc/k2e/src/csl_mpuGetBaseAddress.c",
    "soc/k2e/src/csl_emif4fGetBaseAddress.c",
];

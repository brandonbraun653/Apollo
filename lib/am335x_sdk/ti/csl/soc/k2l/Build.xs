...
/* CSL Version File */
var cslSocFile = [
    "soc/k2l/src/csl_version.c",
    "soc/k2l/src/csl_racGetBaseAddress.c", 
    "soc/k2l/src/csl_gpioGetBaseAddress.c",
    "soc/k2l/src/csl_edma3GetBaseAddress.c",
    "soc/k2l/src/csl_cpIntcGetBaseAddress.c",
    "soc/k2l/src/csl_timerGetBaseAddress.c",
    "soc/k2l/src/csl_pllcGetBaseAddress.c",
    "soc/k2l/src/csl_mpuGetBaseAddress.c",
    "soc/k2l/src/csl_emif4fGetBaseAddress.c",
];
...
/* DFE IP File: There are no source files associated with the DFE Module. */
var dfeIPFile = [
];
...
/* TAC IP File */
var tacIPFile = [
    "src/ip/tac2/V1/csl_tac2_regsBEAux.c",
    "src/ip/tac2/V1/csl_tac2_regsFEAux.c",
    "src/ip/tac2/V1/csl_tac2_regsSGCPAux.c", 
];
...
function getSources ()
{
    ...
    /* Add all the DFE Files. */ 
//    for (index = 0; index < dfeIPFile.length; index++)
//        cslFiles[cslFiles.length++] = dfeIPFile[index];

...
#*******************************************************************************
#* FILE NAME: ./test/am572x/armv7/wdt_test_am572x.xa15fg.mk
#*
...
# INCLUDE Directories
INCDIR := $(PDK_INSTALL_PATH)/ti/csl;$(PDK_INSTALL_PATH);$(PDK_INSTALL_PATH)/ti/csl/test/wdt;$(PDK_INSTALL_PATH)/ti/csl/test/wdt/am572x/armv7
...
COMMONSRCC = \
    test/wdt/am572x/armv7/wdt_main.c

# FLAGS for the COMMONSRC Files
COMMONSRCCFLAGS =   -DSOC_AM572x  -I./test/wdt/am572x/armv7 -I. 
...
$(COMMONSRCCOBJS):.\test\wdt\am572x\armv7\wdt_test_am572x.xa15fg.mk
.\test\wdt\am572x\armv7\wdt_test_am572x.xa15fg.mk:
...
$(BINDIR)/am572x/armv7/wdt_test_am572x.xa15fg : $(COMMONSRCCOBJS)
	@echo linking $? into $@ ...
